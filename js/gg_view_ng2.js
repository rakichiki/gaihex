...
//                                      Math.floor(high_y + (icons * 6 - GG_VIEW_HEX_HIGH * 2 + 3) * zoom),
                                      Math.floor(high_y + (icons * 5 - GG_VIEW_HEX_HIGH * 1.47) * zoom + 6 * zoom * 0.5),
                                      6 * zoom * 0.8,
                                      6 * zoom * 0.8);
                }
...
//                                      Math.floor(high_y - (GG_VIEW_HEX_HIGH * 1.65 - 4.5)* zoom),
                                      ...
                                      4 * zoom);
                    context.globalAlpha = 1;
                    context.drawImage(gg.view.data.etc_img[GG_DATA_IMAGE_PATH + GG_ANIMATION_IMG_PATH + '/hitpoint_plus_01_0240.png'],
                                      0,
                                      0,
                                      48,
                                      60,
                                      ...
                                      3 * zoom,
                                      4 * zoom);
                    context.drawImage(gg.view.data.etc_img[GG_DATA_IMAGE_PATH + GG_ANIMATION_IMG_PATH + '/hitpoint_plus_00_0240.png'],
                                      0,
                                      0,
                                      48,
                                      60,
                                      Math.floor(width_x + GG_VIEW_IMAGE_SIZE * zoom * 0.65 + 3 * zoom),
                                      Math.floor(high_y - GG_VIEW_HEX_HIGH * 0.86 * zoom + 5 * zoom * 0.3),
                                      3 * zoom,
                                      4 * zoom);
                    //context.globalAlpha = 1;
                ...
                if (units[i_count][i_amari][unit_count].status_icons != null) {
                    for (var icons = 0; icons < units[i_count][i_amari][unit_count].status_icons.length; icons++) {
                        ...
                        context.drawImage(gg.view.data.etc_img[img_name],
                                          ...
                                          Math.floor(high_y + (icons * 5 + 3 - GG_VIEW_HEX_HIGH * 2 - fade_y) * zoom + 6 * zoom * 0.5),
                                          6 * zoom * 0.8,
                                          6 * zoom * 0.8);
                    }
                }
...
gg.view.drow_area = function() {
    ...
    var now_date = new Date();
    if (now_date.getTime() - gg.view.data.now < 10) {
